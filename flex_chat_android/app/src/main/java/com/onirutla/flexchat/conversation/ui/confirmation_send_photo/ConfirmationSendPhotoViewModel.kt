...
@HiltViewModel
class ConfirmationSendPhotoViewModel @Inject constructor(
    private val attachmentRepository: AttachmentRepository,
) : ViewModel() {

    private val _state = MutableStateFlow(ConfirmationSendPhotoState())
    ...
    fun onEvent(event: ConfirmationSendPhotoEvent) {
        when (event) {
            ConfirmationSendPhotoEvent.OnSendClick -> {
...
//                    attachmentRepository.createAttachment()
            ...
            is ConfirmationSendPhotoEvent.OnCaptionChange -> {
