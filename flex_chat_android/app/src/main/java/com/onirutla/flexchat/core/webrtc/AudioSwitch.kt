...
class AudioSwitch internal constructor(
    ...
    private fun addAvailableAudioDevices(bluetoothHeadsetName: String?) {
        Timber.d("[addAvailableAudioDevices] wiredHeadsetAvailable: $wiredHeadsetAvailable, bluetoothHeadsetName: $bluetoothHeadsetName")
        mutableAudioDevices.clear()
        preferredDeviceList.forEach { audioDevice ->
            Timber.v("[addAvailableAudioDevices] audioDevice: ${audioDevice.simpleName}")
            when (audioDevice) {
                ...
                AudioDevice.WiredHeadset::class.java -> {
                    Timber.v("[addAvailableAudioDevices] #WiredHeadset; wiredHeadsetAvailable: $wiredHeadsetAvailable")
                ...
                AudioDevice.Earpiece::class.java -> {
                    ...
                    Timber.v("[addAvailableAudioDevices] #Earpiece; hasEarpiece: $hasEarpiece, wiredHeadsetAvailable: $wiredHeadsetAvailable")
