...
class FlexChatPeerConnectionFactory constructor(
    ...
    /**
     * Builds a [FlexChatPeerConnection] that wraps the WebRTC [PeerConnection] and exposes several
     * helpful handlers.
     *
     ...
     * @return [FlexChatPeerConnection] That's fully set up and can be observed and used to send and
     * receive tracks.
     */
