...
val LocalWebRtcSessionManager: ProvidableCompositionLocal<WebRtcSessionManager> = staticCompositionLocalOf {
    error("WebrtcSessionManager was not initialized")
}
...
class WebRtcSessionManagerImpl(
    ...
    private val peerConnection: FlexChatPeerConnection by lazy {
